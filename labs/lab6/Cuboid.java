...
public class Cuboid {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(cuboids, new Comparator<Cuboid>(){
        	@Override
        	public int compare(Cuboid a1, Cuboid a2) {
        		return Double.compare(a1.getLength(), a2.getLength());
        	}
        });
        ...
        Arrays.sort(cuboids, new Comparator<Cuboid>(){
        	@Override
        	public int compare(Cuboid a1, Cuboid a2) {
        		return Double.compare(a1.getVolume(), a2.getVolume());
        	}
        });
        for (Cuboid c: cuboids)
            System.out.println(c);
        ...
        Arrays.sort(cuboids, new Comparator<Cuboid>(){
        	@Override
        	public int compare(Cuboid a1, Cuboid a2) {
        		int result =  Double.compare(a1.getLength(), a2.getLength());
        		if (result == 0) {
        			result = Double.compare(a1.getArea(), a2.getArea());
        		}
        		return result;
        	}
        });
