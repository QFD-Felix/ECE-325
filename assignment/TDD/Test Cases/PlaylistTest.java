...
public class PlaylistTest extends TestCase {
    ...
    public void test_sortByArtist() {
    	...
    	String pre_art = aPlaylist.get(0).getArtist();
    	for(Song song: aPlaylist) {
    		assertTrue(song.getArtist().toLowerCase().compareTo(pre_art.toLowerCase()) >= 0);
    		pre_art = song.getArtist();
    	}
    }
    ...
    public void test_sortByTitle() {
    	...
    	String pre_title = aPlaylist.get(0).getTitle();
    	for(Song song: aPlaylist) {
    		assertTrue(song.getTitle().toLowerCase().compareTo(pre_title.toLowerCase()) >= 0);
    		pre_title = song.getTitle();
    	}
    }
}
